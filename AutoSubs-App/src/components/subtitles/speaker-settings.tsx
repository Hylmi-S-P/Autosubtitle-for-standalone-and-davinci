    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className={`flex-1 justify-center gap-2 px-3 ${!colorMod.enabled ? "opacity-70" : ""}`}
        >
      ...
      <PopoverContent className="w-52 space-y-4">
        <div className="flex items-center gap-2">
          <Switch
            ...
            onCheckedChange={(checked) =>
              onColorModChange({ ...colorMod, enabled: checked })
            }
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              onColorModChange({ ...colorMod, color: e.target.value })
            }
        ...
        <div className="flex flex-wrap gap-2">
          {DEFAULT_PRESETS.map((preset) => (
            <button
              ...
              onClick={() =>
                colorMod.enabled &&
                onColorModChange({ ...colorMod, color: preset })
              }
              disabled={!colorMod.enabled}
            >
    ...
    <div className="space-y-2.5 p-3 min-w-82">
      <div className="flex items-center gap-10">
        <Input
          value={speaker.name}
          onChange={(e) =>
            onSpeakerChange({ ...speaker, name: e.target.value })
          }
      ...
      <ButtonGroup className="w-full">
        <ColorButton
          ...
          onColorModChange={(updated) =>
            onSpeakerChange({ ...speaker, fill: updated })
          }
        />
        <ColorButton
          ...
          onColorModChange={(updated) =>
            onSpeakerChange({ ...speaker, outline: updated })
          }
        />
        <ColorButton
          ...
          onColorModChange={(updated) =>
            onSpeakerChange({ ...speaker, border: updated })
          }
        />
      </ButtonGroup>
    </div>
